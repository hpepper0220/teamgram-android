...
public class SkContactsFragment extends BaseFragment implements NotificationCenter.NotificationCenterDelegate {
    ...
    public interface ContactsActivityDelegate {
        void didSelectContact(TLRPC.User user, String param, SkContactsFragment activity);
    }
...
//                    sortItem.setVisibility(!isEmpty && !item.isSearchFieldVisible() ? View.VISIBLE : View.GONE);
                    sortItem.setVisibility(!isEmpty ? View.VISIBLE : View.GONE);
                }
            }
        };
...
//                measureChildWithMargins(actionBar, widthMeasureSpec, 0, heightMeasureSpec, 0);
                ((MarginLayoutParams) emptyView.getLayoutParams()).topMargin = 0;
                ((MarginLayoutParams) listView.getLayoutParams()).topMargin = 0;
                ...
                if (object instanceof TLRPC.User) {
                    ...
                    if (returnAsResult) {
                        ...
                        if (createSecretChat) {
                            ...
                            if (getMessagesController().checkCanOpenChat(args, SkContactsFragment.this)) {
//                                mParentActivity.presentFragment(new ChatActivity(args), needFinishFragment);
                    ...
                    if (!str.equals("section")) {
                        ...
                        NewContactBottomSheet activity = new NewContactBottomSheet(SkContactsFragment.this, getContext());
                    ...
                    AlertsCreator.createContactInviteDialog(SkContactsFragment.this, contact.first_name, contact.last_name, contact.phones.get(0));
                }
            } else {
...
//                            mParentActivity.presentFragment(new InviteContactsActivity());
                        }
                        ...
                        if (row == 0) {
                            ...
                            mParentActivity.presentFragment(new GroupInviteActivity(chatId != 0 ? chatId : channelId));
                        }
                    } else {
                        if (row == 0) {
                            if (MessagesController.getInstance(currentAccount).isFrozen()) {
                            ...
                            new NewContactBottomSheet(SkContactsFragment.this, getContext()) {
                                @Override
            ...
            public boolean onItemClick(View view, int position) {
                if (listView.getAdapter() == listViewAdapter) {
                    ...
                    if (listViewAdapter.hasStories && section == 1 && view instanceof UserCell) {
                        ...
                        ItemOptions filterOptions = ItemOptions.makeOptions(SkContactsFragment.this, view)
                                ...
                                .add(R.drawable.msg_discussion, LocaleController.getString(R.string.SendMessage), () -> {
                                    mParentActivity.presentFragment(ChatActivity.of(dialogId));
                                })
                                .add(R.drawable.msg_openprofile, LocaleController.getString(R.string.OpenProfile), () -> {
                                    mParentActivity.presentFragment(ProfileActivity.of(dialogId));
                                })
                                .addIf(!muted, R.drawable.msg_mute, LocaleController.getString(R.string.NotificationsStoryMute), () -> {
                                    ...
                                    BulletinFactory.of(SkContactsFragment.this).createUsersBulletin(Arrays.asList(user), AndroidUtilities.replaceTags(LocaleController.formatString("NotificationsStoryMutedHint", R.string.NotificationsStoryMutedHint, name))).show();
                                })
                                .addIf(muted, R.drawable.msg_unmute, LocaleController.getString(R.string.NotificationsStoryUnmute), () -> {
                                    ...
                                    BulletinFactory.of(SkContactsFragment.this).createUsersBulletin(Arrays.asList(user), AndroidUtilities.replaceTags(LocaleController.formatString("NotificationsStoryUnmutedHint", R.string.NotificationsStoryUnmutedHint, name))).show();
                                });
...
//        actionBar.hideActionMode();
    ...
    private void performSelectedContactsDelete() {
        ...
        builder.setPositiveButton(LocaleController.getString(R.string.Delete), (dialog, which) -> {
            ...
            getContactsController().deleteContactsUndoable(getContext(), SkContactsFragment.this, contacts);
