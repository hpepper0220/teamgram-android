...
public class LinkCell extends FrameLayout {
    ...
    public void setSlug(String slug) {
        this.slug = slug;
        this.link = "https://ssgrame.com/giftcode/" + slug;
        linkView.setText("ssgrame.com/giftcode/" + slug);
    }
    ...
    public void hideSlug(Runnable onHiddenLinkClicked) {
        ...
        SpannableStringBuilder builder = new SpannableStringBuilder("ssgrame.com/giftcode/" + slug);
        if (slug == null) {
